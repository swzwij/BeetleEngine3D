...
class ConsolseRenderingEngine
{
public:
	ConsolseRenderingEngine()
	{
		m_nScreenWidth = 80;
		m_nScreenHeight = 30;
...
public:
	void Start()
	{
		// Start the thread
		m_bAtomActive = true;
		std::thread t = std::thread(&ConsolseRenderingEngine::GameThread, this);
...
std::atomic<bool> ConsolseRenderingEngine::m_bAtomActive(false);
std::condition_variable ConsolseRenderingEngine::m_cvGameFinished;
std::mutex ConsolseRenderingEngine::m_muxGame;